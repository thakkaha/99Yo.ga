...
{
var today = new Date(2024,08,30,00,00,00);
}
var months = []
...
$("div.event:contains('ब्रह्मा')").css("background-color","#fed");
$("div.event:contains('विष्णु')").css("background-color","#ede");
$("div.event:contains('महेश')").css("background-color","#aef");
}
